...
function peg$parse(input, options) {
  ...
  var peg$f75 = function(head, tail) { return buildLogicalExpression(head, tail); };
  ...
  var peg$f79 = function(test, consequent, alternate) {
      return {
  ...
  var peg$f82 = function(left, operator, right) {
      return {
        type: "AssignmentExpression",
        operator: operator,
        left: left,
  ...
  var peg$f88 = function(head, tail) { return buildList(head, tail, 1); };
  var peg$f89 = function(declarations) {
      return {
  ...
  var peg$f94 = function(expression) { return expression; };
  var peg$f95 = function(expression) { return expression; };
  var peg$f96 = function() { return { type: "EmptyStatement" }; };
  var peg$f97 = function(expression) {
      return {
  ...
  var peg$f100 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test }; };
  var peg$f101 = function(test, body) { return { type: "WhileStatement", test: test, body: body }; };
  ...
  var peg$f104 = function(left, right, body) {
      return {
        type: "ForInStatement",
        left: left,
        right: right,
  ...
  var peg$f105 = function(declarations, right, body) {
      return {
        type: "ForInStatement",
        left: {
          type: "VariableDeclaration",
  ...
  var peg$f129 = function(head, tail) {
      return buildList(head, tail, 3);
    };
